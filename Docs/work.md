...
{   
    [
        ...
        ...
```
*Вывод соответевует выдачи мини-карточек при запросе по id.   
см. блок works в разделе [Docs/search-ids.md#Получение-миникарточек-по-их-ID](search-ids.md#Получение-миникарточек-по-их-ID)*
Из дополнительных особенностей: параметр mark_id, содержащий номер отметки текущего пользователя, если он голосовал за это произведение как похожее (0 если не отмечал его таковым).
